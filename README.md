...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? A semantic element clearly describes its meaning to both the browser and the developer.
...
5. Explain why git is valuable to a team of developers. Git is very valuable to a team of developers because it allows them to work, collaborate and commit changes on a project. It also allows them to go back and undo changes and make improvements in the future.
